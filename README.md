...
- `notification.email.mock=true` - режим мок-отправки email (логирование вместо реальной отправки)

### Режим работы с email:
Используется мок-отправка email - все письма логируются в консоль вместо реальной отправки.
